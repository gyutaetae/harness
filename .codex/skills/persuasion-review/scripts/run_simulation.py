...
# personas/, runs/, feature-ideas.md는 .codex/ 바깥(레포 루트 persuasion-data/)에 둠.
# nested Codex 세션이 skill bundle 자체를 수정하지 않도록 데이터와 실행 산출물을 분리한다.
# __file__ = <repo>/.codex/skills/persuasion-review/scripts/run_simulation.py
# → parents[4] = <repo>
